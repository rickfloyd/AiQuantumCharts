    ...
    <div className="bg-gradient-to-b from-black via-gray-950 to-black min-h-screen text-gray-100">
      <header className="flex items-center justify-between px-6 py-4 border-b border-pink-900/30">
        ...
        <nav className="flex items-center space-x-6 text-base">
          ...
          <a href="#markets" className="text-blue-400 hover:text-blue-300">Markets</a>
          <a href="#wallet" className="text-pink-400 hover:text-pink-300">Wallet</a>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-br from-pink-950/50 to-blue-950/50 rounded-lg p-6 border border-pink-900/30">
          <div className="flex items-center mb-2">
            <span className="bg-gradient-to-r from-pink-600 to-pink-500 text-white px-3 py-1 rounded-full text-xs font-bold mr-2">BTC</span>
        ...
        <div className="bg-gradient-to-br from-blue-950/50 to-pink-950/50 rounded-lg p-6 border border-blue-900/30">
          <div className="flex items-center mb-2">
            <span className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-3 py-1 rounded-full text-xs font-bold mr-2">ETH</span>
      ...
      <div className="bg-gradient-to-br from-pink-950/30 to-blue-950/30 rounded-lg p-6 mb-8 border border-pink-900/30">
        <h2 className="text-lg font-bold mb-4 bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-transparent">BTC/USD Chart</h2>
      ...
      <form className="bg-gradient-to-br from-blue-950/30 to-pink-950/30 rounded-lg p-6 flex flex-col gap-4 max-w-md mx-auto border border-blue-900/30">
        ...
        <input type="number" placeholder="Amount" className="bg-black/50 text-gray-100 rounded px-3 py-2 border border-pink-900/30 focus:border-pink-500 focus:outline-none" />
        <input type="number" placeholder="Price" className="bg-black/50 text-gray-100 rounded px-3 py-2 border border-blue-900/30 focus:border-blue-500 focus:outline-none" />
        <button type="submit" className="bg-gradient-to-r from-pink-600 to-blue-600 text-white font-bold py-2 rounded hover:from-pink-500 hover:to-blue-500">Sell</button>
      </form>
    </main>
