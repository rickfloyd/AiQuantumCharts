...
export default function CommunityHub() {
  ...
  useEffect(() => {
    ...
    // Mock chat rooms
    setChatRooms([
      { id: '1', name: 'General Trading', description: 'General discussion about trading', memberCount: 1247, isActive: true, category: 'general', level: 'public' },
      { id: '2', name: 'Forex Masters', description: 'Professional forex trading discussion', memberCount: 832, isActive: true, category: 'forex', level: 'premium' },
      { id: '3', name: 'Crypto Alerts', description: 'Real-time crypto signals and alerts', memberCount: 2156, isActive: true, category: 'crypto', level: 'public' },
      { id: '4', name: 'Stock Picks', description: 'Share your best stock picks', memberCount: 945, isActive: true, category: 'stocks', level: 'premium' },
      { id: '5', name: 'Options Strategy', description: 'Advanced options trading strategies', memberCount: 567, isActive: true, category: 'options', level: 'vip' },
      { id: '6', name: '🤖 AI Quantum Signals', description: 'Exclusive AI-powered trading signals', memberCount: 234, isActive: true, category: 'ai-signals', level: 'vip' },
      { id: '7', name: '💎 Elite Traders', description: 'Only for verified profitable traders', memberCount: 89, isActive: true, category: 'elite', level: 'vip' }
    ]);
  }, []);
